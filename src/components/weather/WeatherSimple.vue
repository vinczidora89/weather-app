<script setup>
  ...
  const iconName = props.type === 'past' ? store.pastIcon(props.index) : store.futureIcon(props.index);
...
<template>
  <div :class="['weather-simple', {'is-even': isEven}]">
    <img v-if="iconName" class="weather-simple__icon" alt="weather icon" :src="iconUrl"/>
    ...
    <span class="weather-simple__data">
