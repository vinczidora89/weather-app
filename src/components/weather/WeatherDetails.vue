    ...
    <Transition name="details-fade">
      <div v-if="state.isOpen" class="weather-details__content">
        <div class="weather-details__data-wrapper">
          ...
          <span class="weather-details__data-number">
            {{ store.weatherCurrent.wind_speed }} m/sec
          </span>
        </div>
        <div class="weather-details__data-wrapper">
          <span class="weather-details__data-label">Humidity:</span>
          <span class="weather-details__data-number">
            {{ store.weatherCurrent.humidity }} %
          </span>
        </div>
          <div class="weather-details__data-wrapper">
            <span class="weather-details__data-label">Pressure:</span>
            <span class="weather-details__data-number">
              {{ store.weatherCurrent.pressure }} hPa
            </span>
          </div>
          <div class="weather-details__data-wrapper">
            <span class="weather-details__data-label">Sunrise/Sunset:</span>
            <span class="weather-details__data-number">
              {{ store.currentSunrise }} / {{ store.currentSunset }}
            </span>
          </div>
      </div>
    </Transition>
